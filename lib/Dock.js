...
var Dock = (_temp = _class = function (_Component) {
  ...
  _createClass(Dock, [{
    ...
    value: function render() {
      ...
      var dimClasses = this.props.dimClasses ? this.props.dimClasses.join(' ') : '';
      var dockStyles = Object.assign.apply(Object, [{}].concat(_toConsumableArray(getDockStyles(this.props, this.state))));
      var dockClasses = this.props.dockClasses ? this.props.dockClasses.join(' ') : '';
      ...
      return _react2.default.createElement(
        ...
        dimMode !== 'none' && !isDimHidden && _react2.default.createElement('div', { className: dimClasses, style: dimStyles, onClick: this.handleDimClick }),
        _react2.default.createElement(
          'div',
          { className: dockClasses, style: dockStyles },
  ...
  dimClasses: _propTypes2.default.array,
  dockStyle: _propTypes2.default.object,
  dockClasses: _propTypes2.default.array,
